...
📄 [`add-apartment-and-contract-features.sql`](./add-apartment-and-contract-features.sql) 파일을 Supabase SQL Editor에서 실행하세요!
...
- `employees` 테이블에 `contract_start`, `contract_end` 추가
